...
function SubmitRequisitionLast() {
  return (
        ...
        <div className="your-team-name">
            ...
            <div className="row">
                ...
                <h3>Expected Starting Date</h3>
                    <p>
                        Select your targeted date Vulputate massa sit arcu id. Aliquam pharetra in
                        egestas etiam massa sit arcu vulputate.
                    </p>
                    <div className="calenderDateView padding">
                        <label>Expected Stating Date</label>
                        <br />
                        <span className="dateView">26th January, 2021</span>
                    </div>
...
export default SubmitRequisitionLast;